...
if (isset($_SESSION['username'])) {
	...
	$con =ConnectDB();
	$checkuserquery="select userid from page_table where page_id=".$_POST['codeid'];
	...
	if($rec['userid']==$_SESSION['username'])
		...
		$query="UPDATE PAGE_TABLE SET ISLOCKED=0 WHERE PAGE_ID=".$CID;
		if(mysqli_query($con,$query))
		{
			echo '{"Result":"1","Data":"","Message":"Page Deleted Sucessfully"}';
			setcookie('pageidis'.$CID,"",time()-(3600*24*365*50));
		}
		else
		{
